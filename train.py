...
def download_data():
    ...
    # download data
    data_file = './cars.zip'
    download_url = 'http://sasmerchandise.com/wp-content/uploads/2020/01/Cars_dataset.zip'
...
saved_model_path = learn.save('cars-dnn', return_path = True)
learn.export()
...
copyfile(saved_model_pkl, './outputs/cars.pkl')